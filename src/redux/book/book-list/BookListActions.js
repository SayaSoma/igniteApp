...
export const loadBookList = (page, searchVal, type) => {
  return function (dispatch) {
    ...
    const url = searchVal
      ? axios.get(`http://skunkworks.ignitesol.com:8000/books/?search=${searchVal}`)
      : type
      ? axios.get(`http://skunkworks.ignitesol.com:8000/books/?topic=${type}`)
      : axios.get(`http://skunkworks.ignitesol.com:8000/books/?page=${page}`)
